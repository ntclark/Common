...
#pragma code_seg(".orpc")
static const FormatInfoRef PDFium_DWebBrowserEvents2_Ndr64ProcTable[] =
    {
...
static const MIDL_SYNTAX_INFO PDFium_DWebBrowserEvents2_SyntaxInfo [  2 ] = 
    {
    {
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    ...
    0,
    0 ,
    (unsigned short *) &PDFium_DWebBrowserEvents2_Ndr64ProcTable[-3],
    0,
    0,
    0,
    0
