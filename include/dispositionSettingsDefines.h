...
{                                                                   \
   ...
   ShowWindow(GetDlgItem(hwnd,IDDI_DISPOSITION_SHOW_STARTUP_PROPERTIES_LABEL),! p -> isGlobalDisposition ? SW_HIDE : SW_SHOW); \
   ShowWindow(GetDlgItem(hwnd,IDDI_DISPOSITION_SHOW_STARTUP_PROPERTIES),! p -> isGlobalDisposition ? SW_HIDE : SW_SHOW); \
   ShowWindow(GetDlgItem(hwnd,IDDI_DISPOSITION_OPEN_LAST_DOCUMENT),! p -> isGlobalDisposition ? SW_HIDE : SW_SHOW); \
}
