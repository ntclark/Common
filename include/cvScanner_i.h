...
#define ICVScanner_ListFiles(This,pszBucket,pszKey,ppResult,descendFolders,includeFolderNames)	\
    ( (This)->lpVtbl -> ListFiles(This,pszBucket,pszKey,ppResult,descendFolders,includeFolderNames) ) 
...
#define ICVScanner_GetLatestSettings(This,pszBundleName,ppSettingsFolder,ppSettingsFiles,ppDates)	\
    ( (This)->lpVtbl -> GetLatestSettings(This,pszBundleName,ppSettingsFolder,ppSettingsFiles,ppDates) ) 

#define ICVScanner_GetLatestVersion(This,pszVersionValue,pszVersionFile,dwVersionValueSize,dwVersionFileSize)	\
    ( (This)->lpVtbl -> GetLatestVersion(This,pszVersionValue,pszVersionFile,dwVersionValueSize,dwVersionFileSize) ) 
